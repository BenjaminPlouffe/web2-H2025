...
export class View {
  ...
  //constructor() {} // pas nécessaire ici!

  toggleDisplayForDivFormAddProduct() {
    ...
    const divFormDeleteProduct = document.getElementById();
  ...
  closeForm(evt) {
    //On doit 'cacher' le div assocé à l'événement et 'reset' son formulaire (function hideAndResetForm) => Utiliser les propriétés target et parentElement ; même si elles sont non reconnues par intellisense, elles fonctionnent
