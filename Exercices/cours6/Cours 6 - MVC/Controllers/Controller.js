...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //Ajouter l'event listener pour le 'change' du input du filtre de la table de produits permettant de faire les actions spécifiées dans les commentaires suivants (le listener est anonyme avec un paramètre evt)
